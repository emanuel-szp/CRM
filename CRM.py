...
class SistemaCRM:
    ...
    def adicionar_registro(self, registro):
        ...
        sql = 'INSERT INTO cliente (nome, telefone, compra_passada) VALUES (%s, %s, %s)'
    ...
    def listar_registro(self):
        ...
        self.cursor.execute('SELECT nome, telefone, compra_passada FROM cliente')
...
registro1= Registro(nome, telefone, compra_passada)
# Adiciona o registro ao sistema CRM
sistema.adicionar_registro(registro1)
